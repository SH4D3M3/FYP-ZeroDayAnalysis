...
if __name__ == '__main__':
    ...
    valid_X = np.reshape(valid_X.values, (valid_X.shape[0], 1, valid_X.shape[1]))
    ...
    predictions = lstm_model.predict(valid_X)
    mse = mean_squared_error(valid_ground, predictions)
